...
<body>
    <div class="container">
        ...
        <form method="post" class="form form-left">
            ...
            <input class="input" type="password" id="password_lama" name="password_lama" placeholder="Enter Password Lama" required>

            <label class="label" for="password_baru">Password Baru</label>
            <input class="input" type="password" id="password_baru" name="password_baru" placeholder="Enter Password Baru" required>

            <label class="label" for="verifikasi_password_baru">Verifikasi Password Baru</label>
            <input class="input" type="password" id="verifikasi_password_baru" name="verifikasi_password_baru" placeholder="Enter Verifikasi Password Baru" required>

            <button type="submit" class="button align-right" name="btnUbah">Ubah Password</button>
        </form>
    </div>
