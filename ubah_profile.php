...
<body>
    <div class="container">
        ...
        <form method="post" class="form form-left">
            ...
            <input class="input" type="text" id="username" name="username" placeholder="Enter Username" value="<?= $data_user['username']; ?>" required>

            <label class="label" for="nama_lengkap">Nama Lengkap</label>
            <input class="input" type="text" id="nama_lengkap" name="nama_lengkap" placeholder="Enter Nama Lengkap" value="<?= $data_user['nama_lengkap']; ?>" required>

            <button type="submit" class="button align-right" name="btnUbah">Ubah Profile</button>
        </form>
    </div>
